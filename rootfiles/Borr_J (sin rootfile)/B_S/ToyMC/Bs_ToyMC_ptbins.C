...
void Bs_ToyMC_ptbins(Int_t ntotal=1010, Int_t seed=5, Double_t ptl=20, Double_t pth=23)
{
  ...
  ifstream entrada (Form("../plots_ptandeta/output_TotalFit_BsFit_nominal_%1.0f_%1.0f.txt",ptl,pth));
  //entrada.is_open();
  if ( !entrada ) 
    {
