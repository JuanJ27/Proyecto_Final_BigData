...
void pruebas1(Double_t ptl=20.0, Double_t pth=23.0)
{
...
for(Long64_t jentry=0; jentry<nentries;jentry++)
 ...
 RooChebychev bkgp("bkgp","Background",M,RooArgList(a0)); 
 ...
 */
 ...
 RooRealVar c("c", "c", 1.0, 0.5, 100.0); // Parámetro de forma
 RooRealVar p("p", "p", 5.4, 5.2, 5.49); // Parámetro de corte
 ...
 RooAddPdf bkg("bkg","bkg",RooArgList(bkgp,argu),RooArgList(fs));
 ...
 canv_nominal->Print(Form("plots_ptandeta2/mass_BsFit_ptbins_%1.0f_%1.0f_NOpull.png",ptl,pth));
 canv_nominal->Print(Form("plots_ptandeta2/mass_BsFit_ptbins_%1.0f_%1.0f_NOpull.pdf",ptl,pth));
 ...
 canv_nominalpull->Print(Form("plots_ptandeta2/mass_BsFitpull_ptbins_%1.0f_%1.0f.png",ptl,pth));
 canv_nominalpull->Print(Form("plots_ptandeta2/mass_BsFitpull_ptbins_%1.0f_%1.0f.pdf",ptl,pth));
